describe("Kiểm tra trường LastName1", () => {
  beforeEach(() => {
    // Mở trang trước mỗi bài kiểm thử
    cy.login_Nam_Test();
  });

  //   it("TC01 : Kiểm thử khi LastName1 hợp lệ", () => {
  ...
  it("TC02 : Kiểm thử khi LastName1 rỗng", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="firstname_1"]').should("be.visible").type("Nguyen");
    cy.get('input[name="lastname_1"]').clear();
    ...
    cy.get('input[name="lastname_1"]').should("have.focus");
  });

  it("TC03 : Kiểm thử khi LastName1 chứa ký tự đặc biệt", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC04 : Kiểm thử khi LastName1 chứa số", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC05 : Kiểm thử khi LastName1 có độ dài ký tự > 50", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="lastname_1"]')
      .should("be.visible")
      .type(
        "Van Ajksdahfjksdhjheiuoweqiruwehfjdhfkjahwsdajdahsfjkafhasjkfhdjafhksjdfhjadkha"
      );
  ...
  it("TC06 : Kiểm thử khi LastName1 có độ dài ký tự < 2", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="firstname_1"]').should("be.visible").type("Nguyen");
    cy.get('input[name="lastname_1"]').should("be.visible").type("V");
  ...
  it("TC07 : Kiểm thử khi LastName1 bắt đầu bằng khoảng trắng", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC08 : Kiểm thử khi LastName1 kết thúc bằng khoảng trắng", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC09 : Kiểm thử khi LastName1 chứa ký tự Unicode", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="firstname_1"]').should("be.visible").type("Nguyen");
    cy.get('input[name="lastname_1"]').should("be.visible").type("Văn A");
