describe("Kiểm tra trường FirstName2", () => {
  beforeEach(() => {
    // Mở trang trước mỗi bài kiểm thử
    cy.login_Nam_Test();
  });

  it("TC01 : Kiểm thử khi FirstName2 hợp lệ", () => {
  ...
  it("TC02 : Kiểm thử khi FirstName2 rỗng", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="firstname_2"]').clear();
    cy.get('input[name="lastname_2"]').should("be.visible").type("Van B");
    ...
    cy.get('input[name="firstname_2"]').should("have.focus");
  });

  it("TC03 : Kiểm thử khi FirstName2 chứa ký tự đặc biệt", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC04 : Kiểm thử khi FirstName2 chứa số", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC05 : Kiểm thử khi FirstName2 có độ dài ký tự > 50", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC06 : Kiểm thử khi FirstName2 có độ dài ký tự < 2", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="firstname_2"]').should("be.visible").type("N");
    cy.get('input[name="lastname_2"]').should("be.visible").type("Van B");
  ...
  it("TC07 : Kiểm thử khi FirstName2 bắt đầu bằng khoảng trắng", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC08 : Kiểm thử khi FirstName2 kết thúc bằng khoảng trắng", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
  ...
  it("TC09 : Kiểm thử khi FirstName2 chứa ký tự Unicode", () => {
    /// Tìm thẻ "Car" dựa trên văn bản "Cars"
    cy.contains("a.nav-link", "Cars").click();
    ...
    cy.get('input[name="firstname_2"]').should("be.visible").type("Nguyễn");
    cy.get('input[name="lastname_2"]').should("be.visible").type("Van B");
