describe("Kiểm tra trường City", () => {
  beforeEach(() => {
    // Mở trang trước mỗi bài kiểm thử
    cy.login_Nam_Test();
  });

  it("TC01 : Kiểm thử khi City hợp lệ", () => {
  ...
  it("TC02 : Kiểm thử khi City rỗng", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
  ...
  it("TC03 : Kiểm thử khi City có độ dài > 50 ký tự", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
  ...
  it("TC04 : Kiểm thử khi City có chứa ký tự đặc biệt", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
  ...
  it("TC05 : Kiểm thử khi City có chứa số", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
    ...
    cy.get("#State").clear().type("Ho Chi Minh");
    cy.get("#City").clear().type("Ho Chi Minh2378472389");
    cy.get("#Address").clear().type("450 Le Van Viet");
    cy.get('button[type="submit"]').click();
  ...
  it("TC06 : Kiểm thử khi City bắt đầu bằng khoảng trắng", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
  ...
  it("TC07 : Kiểm thử khi City có khoảng trắng ở cuối", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
  ...
  it("TC08 : Kiểm thử khi City có chứa kí tự Unicode", () => {
    // Click on the Account dropdown
    cy.get("a.nav-link.dropdown-toggle").contains("Account").click();
    ...
    cy.get("#State").clear().type("Ho Chi Minh");
    cy.get("#City").clear().type("Hồ Chí Minh");
    cy.get("#Address").clear().type("450 Le Van Viet");
    cy.get('button[type="submit"]').click();
